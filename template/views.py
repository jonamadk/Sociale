...
class CreateResourceView(APIView):
    ...
    def post(self , request , *args, **kwargs):
        ...
        '''
        if request.user.has_perms('template.add_templateresource'):
            ...
            if serializer.is_valid():
                ...
                resource = TemplateResource.objects.create(headerBackgroundColor = data.get("headerBackgroundColor"),
                                                            headerFontColor = data.get("headerFontColor"),
                                                            bodyBackgroundcolor = data.get("bodyBackgroundcolor"),
                                                            bodyFontColor = data.get("bodyFontColor"),
                                                            headerNav1 = data.get("headerNav1"),
                                                            headerNav2 =  data.get("headerNav2"),
                                                            headerNav3 = data.get("headerNav3"),
                                                            bodyButtonColor = data.get("bodyButtonColor"),
    ...
    def put(self , request , *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                resource = TemplateResource.objects.get(id = request.data.get('template_resource_id'))
                resource.headerBackgroundColor = data.get("headerBackgroundColor")
...
class TemplateResourceRetrieveView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            resource = TemplateResource.objects.get(template_name= template_name)
