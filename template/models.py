...
class TemplateResource(models.Model):
    headerBackgroundColor= models.CharField(max_length = 100 , blank = True , null = True)
    ...
    user = models.ForeignKey(UserModel, on_delete = models.CASCADE)
    template_name = models.CharField(max_length = 250 , blank = True , null = True , unique = True)
    template_url = models.CharField(max_length = 250 , blank = True , null = True, unique= True)
