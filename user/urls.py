...
urlpatterns = [
    ...
    path("verify/otp/", OTPVerifyView.as_view(), name="tp-verify-forgot-password"),
    ...
    path("verify/", OTPVerifyForForgetPassword.as_view()),
    path("setpassword/", AddNewPassword.as_view())
